...
export function getPuzzle(dif) {
	...
	//if (dif != "expert") {
		if ((i == 1 || i == 3) && dif == "expert" && rng > 0 && rng % 2 == 0) {
			obj = mirror(puzzle,solution);
			puzzle = obj.puzzle;
			solution = obj.solution;
			obj = invert(puzzle,solution);
			puzzle = obj.puzzle;
			solution = obj.solution;
			obj = mixRegCol(puzzle,solution);
			puzzle = obj.puzzle;
			solution = obj.solution;
	...
	function mixRegCol(puzzle,solution) {
	...
	function mixRegRow(puzzle,solution) {
	let rng = Math.floor(Math.random() * 5);
	let sortedP = [];
	let sortedS = [];
	switch (rng) {
	...
	function invert(puzzle,solution) {
	let sortP = [];
	let sortS = [];
	for (let i = 8; i >= 0; i--) {
		let sortRegP = [];
	...
	function mirror(puzzle,solution) {
	puzzle = getCoord(puzzle);
	solution = getCoord(solution);
	...
	return {
		puzzle: reJoin(puzzle),
		solution: reJoin(solution)
	}
	}

	function mixLines(puzzle,solution,line,regLine,rng) {
	if (regLine == 1) {
		switch (rng) {
			case 1:
				puzzle = puzzle.map(e => {
	...
	function mixMix(puzzle,solution) {
	puzzle = getCoord(puzzle);
	solution = getCoord(solution);
	...
	if (count == 1) {
		...
		let obj = mixLines(puzzle,solution,"column",regCol,rng);
		puzzle = obj.puzzle;
		solution = obj.solution;
	} else if (count == 2) {
		let rCols = [1,2,3];
		...
		let obj = mixLines(puzzle,solution,"column",regCol1,rng1);
		puzzle = obj.puzzle;
		solution = obj.solution;
		obj = mixLines(puzzle,solution,"column",regCol2,rng2);
		puzzle = obj.puzzle;
		solution = obj.solution;
	} else {
		let rng1 = Math.ceil(Math.random() * 5);
		...
		let obj = mixLines(puzzle,solution,"column",1,rng1);
		puzzle = obj.puzzle;
		solution = obj.solution;
		obj = mixLines(puzzle,solution,"column",2,rng2);
		puzzle = obj.puzzle;
		solution = obj.solution;
		obj = mixLines(puzzle,solution,"column",3,rng3);
		puzzle = obj.puzzle;
		solution = obj.solution;
	}
	...
	if (count == 1) {
		...
		let rng = Math.ceil(Math.random() * 5);
		let obj = mixLines(puzzle,solution,"row",regRow,rng);
		puzzle = obj.puzzle;
		solution = obj.solution;
	} else if (count == 2) {
		let rRows = [1,2,3];
		...
		let rng1 = Math.ceil(Math.random() * 5);
		let rng2 = Math.ceil(Math.random() * 5);
		let obj = mixLines(puzzle,solution,"row",regRow1,rng1);
		puzzle = obj.puzzle;
		solution = obj.solution;
		obj = mixLines(puzzle,solution,"row",regRow2,rng2);
		puzzle = obj.puzzle;
		solution = obj.solution;
	} else {
		let rng1 = Math.ceil(Math.random() * 5);
		let rng2 = Math.ceil(Math.random() * 5);
		let rng3 = Math.ceil(Math.random() * 5);
		let obj = mixLines(puzzle,solution,"row",1,rng1);
		puzzle = obj.puzzle;
		solution = obj.solution;
		obj = mixLines(puzzle,solution,"row",2,rng2);
		puzzle = obj.puzzle;
		solution = obj.solution;
		obj = mixLines(puzzle,solution,"row",3,rng3);
		puzzle = obj.puzzle;
		solution = obj.solution;
	}
	return {
