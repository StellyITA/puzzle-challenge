...
export default function BasicTechniques() {
	return (
		<div className='grid text-justify p-5 pt-1'>
			<Link 
				href='/'
			...
			<h2 className='text-2xl pt-5 pb-1'>2. Single Possibility</h2>
			<p className='grid bg-yellow-50 p-1 px-2 border border-indigo-200'>
			...
			<Link
				href='/sudoku'
				className='place-self-center hover:text-indigo-900 active:text-indigo-900 pt-2 text-3xl'
			>Click here to play now!</Link>
		</div>
	)
}
